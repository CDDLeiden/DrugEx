...
export BASE_IMAGE_TAG="13.1.0-runtime-ubuntu24.04" # cuda base image tag, translated to nvidia/cuda:12.0.1-cudnn8-runtime-ubuntu22.04
export PYTHON_VERSION="3.12" # python version for the conda base environment
